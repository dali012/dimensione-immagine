        ...
        <div className="space-y-8 text-white/80 font-light leading-relaxed">
          <section>
            ...
            <p className="mb-4">
              ...
              sito o navighi da una pagina all'altra di esso.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mb-6">
              ...
              <p>
                ...
                elettronica, o nella misura strettamente necessaria per erogare
                un servizio esplicitamente richiesto dall'utente. Non vengono
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              impostazioni del proprio browser. Attenzione: la disabilitazione
              totale o parziale dei cookie tecnici può compromettere l'utilizzo
              delle funzionalità del sito riservate agli utenti registrati. Al
              contrario, la fruibilità dei contenuti pubblici è possibile anche
